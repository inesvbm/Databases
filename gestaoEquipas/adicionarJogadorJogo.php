	...
	try{
		...
		if ($connection->connect_errno != 0){
			...
			while($add=mysqli_fetch_array($adicionaJogadorJogos)){
				$connection->query("INSERT INTO `jogadores_jogo`(`id_jogo`, `Nome_torneio`, `CC`, `Nome_equipa`, `Posicao`, `Suplente`, `Golos_marcados`) VALUES ('".$add[0]."', '".$add[1]."', '".$cc."', '".$equipa."','".$posicao."',0,0)");
			}
